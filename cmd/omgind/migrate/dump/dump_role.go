...
func Dump_role(ctx context.Context, eclient *mainent.Client, datafile string) error {
	...
	for i := 0; i < page; i++ {
		...
		query = query.Order(mainent.Asc(sysrole.FieldID), mainent.Asc(sysrole.FieldSort))
