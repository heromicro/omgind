...
func init() {
	orgdeptMixin := entity.OrgDept{}.Mixin()
	orgdeptMixinFields0 := orgdeptMixin[0].Fields()
	_ = orgdeptMixinFields0
	orgdeptMixinFields1 := orgdeptMixin[1].Fields()
	_ = orgdeptMixinFields1
	orgdeptMixinFields2 := orgdeptMixin[2].Fields()
	_ = orgdeptMixinFields2
	orgdeptMixinFields3 := orgdeptMixin[3].Fields()
	_ = orgdeptMixinFields3
	orgdeptMixinFields4 := orgdeptMixin[4].Fields()
	_ = orgdeptMixinFields4
	orgdeptMixinFields5 := orgdeptMixin[5].Fields()
	_ = orgdeptMixinFields5
	orgdeptMixinFields6 := orgdeptMixin[6].Fields()
	_ = orgdeptMixinFields6
	orgdeptFields := entity.OrgDept{}.Fields()
	_ = orgdeptFields
	// orgdeptDescIsDel is the schema descriptor for is_del field.
	orgdeptDescIsDel := orgdeptMixinFields1[0].Descriptor()
	// orgdept.DefaultIsDel holds the default value on creation for the is_del field.
	orgdept.DefaultIsDel = orgdeptDescIsDel.Default.(bool)
	// orgdeptDescSort is the schema descriptor for sort field.
	orgdeptDescSort := orgdeptMixinFields2[0].Descriptor()
	// orgdept.DefaultSort holds the default value on creation for the sort field.
	orgdept.DefaultSort = orgdeptDescSort.Default.(int32)
	// orgdeptDescCreatedAt is the schema descriptor for created_at field.
	orgdeptDescCreatedAt := orgdeptMixinFields3[0].Descriptor()
	// orgdept.DefaultCreatedAt holds the default value on creation for the created_at field.
	orgdept.DefaultCreatedAt = orgdeptDescCreatedAt.Default.(func() time.Time)
	// orgdeptDescUpdatedAt is the schema descriptor for updated_at field.
	orgdeptDescUpdatedAt := orgdeptMixinFields3[1].Descriptor()
	// orgdept.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	orgdept.DefaultUpdatedAt = orgdeptDescUpdatedAt.Default.(func() time.Time)
	// orgdept.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	orgdept.UpdateDefaultUpdatedAt = orgdeptDescUpdatedAt.UpdateDefault.(func() time.Time)
	// orgdeptDescIsActive is the schema descriptor for is_active field.
	orgdeptDescIsActive := orgdeptMixinFields4[0].Descriptor()
	// orgdept.DefaultIsActive holds the default value on creation for the is_active field.
	orgdept.DefaultIsActive = orgdeptDescIsActive.Default.(bool)
	// orgdeptDescMemo is the schema descriptor for memo field.
	orgdeptDescMemo := orgdeptMixinFields5[0].Descriptor()
	// orgdept.DefaultMemo holds the default value on creation for the memo field.
	orgdept.DefaultMemo = orgdeptDescMemo.Default.(string)
	// orgdept.MemoValidator is a validator for the "memo" field. It is called by the builders before save.
	orgdept.MemoValidator = orgdeptDescMemo.Validators[0].(func(string) error)
	// orgdeptDescIsLeaf is the schema descriptor for is_leaf field.
	orgdeptDescIsLeaf := orgdeptMixinFields6[4].Descriptor()
	// orgdept.DefaultIsLeaf holds the default value on creation for the is_leaf field.
	orgdept.DefaultIsLeaf = orgdeptDescIsLeaf.Default.(bool)
	// orgdeptDescName is the schema descriptor for name field.
	orgdeptDescName := orgdeptFields[0].Descriptor()
	// orgdept.NameValidator is a validator for the "name" field. It is called by the builders before save.
	orgdept.NameValidator = orgdeptDescName.Validators[0].(func(string) error)
	// orgdeptDescCode is the schema descriptor for code field.
	...
	orgdept.DefaultID = orgdeptDescID.Default.(func() string)
	// orgdept.IDValidator is a validator for the "id" field. It is called by the builders before save.
	orgdept.IDValidator = func() func(string) error {
		validators := orgdeptDescID.Validators
	...
	orgstaffDescResiAddrID := orgstaffFields[8].Descriptor()
	...
	orgstaffDescWorkerNo := orgstaffFields[9].Descriptor()
	...
	systeamMixin := entity.SysTeam{}.Mixin()
	systeamMixinFields0 := systeamMixin[0].Fields()
	_ = systeamMixinFields0
	systeamMixinFields1 := systeamMixin[1].Fields()
	_ = systeamMixinFields1
	systeamMixinFields2 := systeamMixin[2].Fields()
	_ = systeamMixinFields2
	systeamMixinFields3 := systeamMixin[3].Fields()
	_ = systeamMixinFields3
	systeamMixinFields4 := systeamMixin[4].Fields()
	_ = systeamMixinFields4
	systeamMixinFields5 := systeamMixin[5].Fields()
	_ = systeamMixinFields5
	systeamFields := entity.SysTeam{}.Fields()
	_ = systeamFields
	// systeamDescSort is the schema descriptor for sort field.
	systeamDescSort := systeamMixinFields1[0].Descriptor()
	// systeam.DefaultSort holds the default value on creation for the sort field.
	systeam.DefaultSort = systeamDescSort.Default.(int32)
	// systeamDescCreatedAt is the schema descriptor for created_at field.
	systeamDescCreatedAt := systeamMixinFields2[0].Descriptor()
	// systeam.DefaultCreatedAt holds the default value on creation for the created_at field.
	systeam.DefaultCreatedAt = systeamDescCreatedAt.Default.(func() time.Time)
	// systeamDescUpdatedAt is the schema descriptor for updated_at field.
	systeamDescUpdatedAt := systeamMixinFields2[1].Descriptor()
	...
	// systeamDescIsActive is the schema descriptor for is_active field.
	systeamDescIsActive := systeamMixinFields3[0].Descriptor()
	// systeam.DefaultIsActive holds the default value on creation for the is_active field.
	systeam.DefaultIsActive = systeamDescIsActive.Default.(bool)
	// systeamDescMemo is the schema descriptor for memo field.
	systeamDescMemo := systeamMixinFields4[0].Descriptor()
	// systeam.DefaultMemo holds the default value on creation for the memo field.
	systeam.DefaultMemo = systeamDescMemo.Default.(string)
	// systeam.MemoValidator is a validator for the "memo" field. It is called by the builders before save.
	systeam.MemoValidator = systeamDescMemo.Validators[0].(func(string) error)
	// systeamDescIsDel is the schema descriptor for is_del field.
	systeamDescIsDel := systeamMixinFields5[0].Descriptor()
	// systeam.DefaultIsDel holds the default value on creation for the is_del field.
	systeam.DefaultIsDel = systeamDescIsDel.Default.(bool)
	// systeamDescName is the schema descriptor for name field.
	systeamDescName := systeamFields[0].Descriptor()
	// systeam.NameValidator is a validator for the "name" field. It is called by the builders before save.
	systeam.NameValidator = systeamDescName.Validators[0].(func(string) error)
	// systeamDescCode is the schema descriptor for code field.
	systeamDescCode := systeamFields[1].Descriptor()
	// systeam.CodeValidator is a validator for the "code" field. It is called by the builders before save.
	systeam.CodeValidator = systeamDescCode.Validators[0].(func(string) error)
	...
	// systeam.IDValidator is a validator for the "id" field. It is called by the builders before save.
	systeam.IDValidator = func() func(string) error {
		validators := systeamDescID.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	systeamuserMixin := entity.SysTeamUser{}.Mixin()
	systeamuserMixinFields0 := systeamuserMixin[0].Fields()
	_ = systeamuserMixinFields0
	systeamuserMixinFields1 := systeamuserMixin[1].Fields()
	_ = systeamuserMixinFields1
	systeamuserMixinFields2 := systeamuserMixin[2].Fields()
	_ = systeamuserMixinFields2
	systeamuserMixinFields3 := systeamuserMixin[3].Fields()
	_ = systeamuserMixinFields3
	systeamuserMixinFields4 := systeamuserMixin[4].Fields()
	_ = systeamuserMixinFields4
	systeamuserMixinFields5 := systeamuserMixin[5].Fields()
	_ = systeamuserMixinFields5
	systeamuserFields := entity.SysTeamUser{}.Fields()
	_ = systeamuserFields
	// systeamuserDescSort is the schema descriptor for sort field.
	systeamuserDescSort := systeamuserMixinFields1[0].Descriptor()
	// systeamuser.DefaultSort holds the default value on creation for the sort field.
	systeamuser.DefaultSort = systeamuserDescSort.Default.(int32)
	// systeamuserDescCreatedAt is the schema descriptor for created_at field.
	systeamuserDescCreatedAt := systeamuserMixinFields2[0].Descriptor()
	// systeamuser.DefaultCreatedAt holds the default value on creation for the created_at field.
	systeamuser.DefaultCreatedAt = systeamuserDescCreatedAt.Default.(func() time.Time)
	// systeamuserDescUpdatedAt is the schema descriptor for updated_at field.
	systeamuserDescUpdatedAt := systeamuserMixinFields2[1].Descriptor()
	// systeamuser.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	systeamuser.DefaultUpdatedAt = systeamuserDescUpdatedAt.Default.(func() time.Time)
	// systeamuser.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	systeamuser.UpdateDefaultUpdatedAt = systeamuserDescUpdatedAt.UpdateDefault.(func() time.Time)
	// systeamuserDescIsActive is the schema descriptor for is_active field.
	systeamuserDescIsActive := systeamuserMixinFields3[0].Descriptor()
	// systeamuser.DefaultIsActive holds the default value on creation for the is_active field.
	systeamuser.DefaultIsActive = systeamuserDescIsActive.Default.(bool)
	// systeamuserDescMemo is the schema descriptor for memo field.
	systeamuserDescMemo := systeamuserMixinFields4[0].Descriptor()
	// systeamuser.DefaultMemo holds the default value on creation for the memo field.
	systeamuser.DefaultMemo = systeamuserDescMemo.Default.(string)
	// systeamuser.MemoValidator is a validator for the "memo" field. It is called by the builders before save.
	systeamuser.MemoValidator = systeamuserDescMemo.Validators[0].(func(string) error)
	// systeamuserDescIsDel is the schema descriptor for is_del field.
	systeamuserDescIsDel := systeamuserMixinFields5[0].Descriptor()
	// systeamuser.DefaultIsDel holds the default value on creation for the is_del field.
	systeamuser.DefaultIsDel = systeamuserDescIsDel.Default.(bool)
	// systeamuserDescTeamID is the schema descriptor for team_id field.
	systeamuserDescTeamID := systeamuserFields[0].Descriptor()
	// systeamuser.TeamIDValidator is a validator for the "team_id" field. It is called by the builders before save.
	systeamuser.TeamIDValidator = systeamuserDescTeamID.Validators[0].(func(string) error)
	// systeamuserDescUserID is the schema descriptor for user_id field.
	systeamuserDescUserID := systeamuserFields[1].Descriptor()
	// systeamuser.UserIDValidator is a validator for the "user_id" field. It is called by the builders before save.
	systeamuser.UserIDValidator = systeamuserDescUserID.Validators[0].(func(string) error)
	// systeamuserDescID is the schema descriptor for id field.
	systeamuserDescID := systeamuserMixinFields0[0].Descriptor()
	// systeamuser.DefaultID holds the default value on creation for the id field.
	systeamuser.DefaultID = systeamuserDescID.Default.(func() string)
	// systeamuser.IDValidator is a validator for the "id" field. It is called by the builders before save.
	systeamuser.IDValidator = func() func(string) error {
		validators := systeamuserDescID.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
