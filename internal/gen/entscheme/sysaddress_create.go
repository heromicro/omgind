...
func (sac *SysAddressCreate) check() error {
	if _, ok := sac.mutation.IsDel(); !ok {
		return &ValidationError{Name: "is_del", err: errors.New(`entscheme: missing required field "SysAddress.is_del"`)}
	}
	if v, ok := sac.mutation.UserID(); ok {
		if err := sysaddress.UserIDValidator(v); err != nil {
			return &ValidationError{Name: "user_id", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.user_id": %w`, err)}
		}
	}
	if v, ok := sac.mutation.OrgID(); ok {
		if err := sysaddress.OrgIDValidator(v); err != nil {
			return &ValidationError{Name: "org_id", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.org_id": %w`, err)}
		}
	}
	if _, ok := sac.mutation.Sort(); !ok {
		return &ValidationError{Name: "sort", err: errors.New(`entscheme: missing required field "SysAddress.sort"`)}
	}
	if _, ok := sac.mutation.IsActive(); !ok {
		return &ValidationError{Name: "is_active", err: errors.New(`entscheme: missing required field "SysAddress.is_active"`)}
	}
	if v, ok := sac.mutation.Memo(); ok {
		if err := sysaddress.MemoValidator(v); err != nil {
			return &ValidationError{Name: "memo", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.memo": %w`, err)}
		}
	}
	if v, ok := sac.mutation.CountryID(); ok {
		if err := sysaddress.CountryIDValidator(v); err != nil {
			return &ValidationError{Name: "country_id", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.country_id": %w`, err)}
		}
	}
	if v, ok := sac.mutation.ProvinceID(); ok {
		if err := sysaddress.ProvinceIDValidator(v); err != nil {
			return &ValidationError{Name: "province_id", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.province_id": %w`, err)}
		}
	}
	if v, ok := sac.mutation.CityID(); ok {
		if err := sysaddress.CityIDValidator(v); err != nil {
			return &ValidationError{Name: "city_id", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.city_id": %w`, err)}
		}
	}
	if v, ok := sac.mutation.CountyID(); ok {
		if err := sysaddress.CountyIDValidator(v); err != nil {
			return &ValidationError{Name: "county_id", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.county_id": %w`, err)}
		}
	}
	if v, ok := sac.mutation.ZipCode(); ok {
		if err := sysaddress.ZipCodeValidator(v); err != nil {
			return &ValidationError{Name: "zip_code", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.zip_code": %w`, err)}
		}
	}
	if v, ok := sac.mutation.Daddr(); ok {
		if err := sysaddress.DaddrValidator(v); err != nil {
			return &ValidationError{Name: "daddr", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.daddr": %w`, err)}
		}
	}
	if v, ok := sac.mutation.FirstName(); ok {
		if err := sysaddress.FirstNameValidator(v); err != nil {
			return &ValidationError{Name: "first_name", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.first_name": %w`, err)}
		}
	}
	if v, ok := sac.mutation.LastName(); ok {
		if err := sysaddress.LastNameValidator(v); err != nil {
			return &ValidationError{Name: "last_name", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.last_name": %w`, err)}
		}
	}
	if v, ok := sac.mutation.AreaCode(); ok {
		if err := sysaddress.AreaCodeValidator(v); err != nil {
			return &ValidationError{Name: "area_code", err: fmt.Errorf(`entscheme: validator failed for field "SysAddress.area_code": %w`, err)}
		}
	}
...
func (u *SysAddressUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("entscheme: missing options for SysAddressCreate.OnConflict")
	}
...
func (u *SysAddressUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		...
		return id, errors.New("entscheme: SysAddressUpsertOne.ID is not supported by MySQL driver. Use SysAddressUpsertOne.Exec instead")
	}
...
func (u *SysAddressUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("entscheme: OnConflict was set for builder %d. Set it on the SysAddressCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("entscheme: missing options for SysAddressCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
