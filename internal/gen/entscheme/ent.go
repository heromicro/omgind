	...
	return func(s *sql.Selector) {
		for _, f := range fields {
			if err := checkColumn(s.TableName(), f); err != nil {
				s.AddError(&ValidationError{Name: f, err: fmt.Errorf("entscheme: %w", err)})
			}
...
//	Aggregate(entscheme.As(entscheme.Sum(field1), "sum_field1"), (entscheme.As(entscheme.Sum(field2), "sum_field2")).
//	Scan(ctx, &v)
...
func Max(field string) AggregateFunc {
	return func(s *sql.Selector) string {
		if err := checkColumn(s.TableName(), field); err != nil {
			s.AddError(&ValidationError{Name: field, err: fmt.Errorf("entscheme: %w", err)})
			return ""
		}
...
func (e *NotFoundError) Error() string {
	return "entscheme: " + e.label + " not found"
}
...
func (e *NotSingularError) Error() string {
	return "entscheme: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "entscheme: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "entscheme: constraint failed: " + e.msg
}
...
func (s *selector) Strings(ctx context.Context) ([]string, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("entscheme: Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) String(ctx context.Context) (_ string, err error) {
	...
	default:
		err = fmt.Errorf("entscheme: Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Ints(ctx context.Context) ([]int, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("entscheme: Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("entscheme: Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Float64s(ctx context.Context) ([]float64, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("entscheme: Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("entscheme: Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Bools(ctx context.Context) ([]bool, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("entscheme: Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("entscheme: Bools returned %d results when one was expected", len(v))
	}
	return
}
