...
import (
	...
	"github.com/heromicro/omgind/internal/gen/entscheme/migrate"
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	if _, ok := c.driver.(*txDriver); ok {
		return nil, errors.New("entscheme: cannot start a transaction within a transaction")
	}
	tx, err := newTx(ctx, c.driver)
	if err != nil {
		return nil, fmt.Errorf("entscheme: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown mutation type %T", m)
	}
}
...
func (c *OrgDeptClient) mutate(ctx context.Context, m *OrgDeptMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown OrgDept mutation op: %q", m.Op())
	}
}
...
func (c *OrgOrganClient) mutate(ctx context.Context, m *OrgOrganMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown OrgOrgan mutation op: %q", m.Op())
	}
}
...
func (c *OrgPositionClient) mutate(ctx context.Context, m *OrgPositionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown OrgPosition mutation op: %q", m.Op())
	}
}
...
func (c *OrgStaffClient) mutate(ctx context.Context, m *OrgStaffMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown OrgStaff mutation op: %q", m.Op())
	}
}
...
func (c *SysAddressClient) mutate(ctx context.Context, m *SysAddressMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysAddress mutation op: %q", m.Op())
	}
}
...
func (c *SysDictClient) mutate(ctx context.Context, m *SysDictMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysDict mutation op: %q", m.Op())
	}
}
...
func (c *SysDictItemClient) mutate(ctx context.Context, m *SysDictItemMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysDictItem mutation op: %q", m.Op())
	}
}
...
func (c *SysDistrictClient) mutate(ctx context.Context, m *SysDistrictMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysDistrict mutation op: %q", m.Op())
	}
}
...
func (c *SysJwtBlockClient) mutate(ctx context.Context, m *SysJwtBlockMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysJwtBlock mutation op: %q", m.Op())
	}
}
...
func (c *SysLoggingClient) mutate(ctx context.Context, m *SysLoggingMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysLogging mutation op: %q", m.Op())
	}
}
...
func (c *SysMenuClient) mutate(ctx context.Context, m *SysMenuMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysMenu mutation op: %q", m.Op())
	}
}
...
func (c *SysMenuActionClient) mutate(ctx context.Context, m *SysMenuActionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysMenuAction mutation op: %q", m.Op())
	}
}
...
func (c *SysMenuActionResourceClient) mutate(ctx context.Context, m *SysMenuActionResourceMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysMenuActionResource mutation op: %q", m.Op())
	}
}
...
func (c *SysRoleClient) mutate(ctx context.Context, m *SysRoleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysRole mutation op: %q", m.Op())
	}
}
...
func (c *SysRoleMenuClient) mutate(ctx context.Context, m *SysRoleMenuMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysRoleMenu mutation op: %q", m.Op())
	}
}
...
func (c *SysUserClient) mutate(ctx context.Context, m *SysUserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysUser mutation op: %q", m.Op())
	}
}
...
func (c *SysUserRoleClient) mutate(ctx context.Context, m *SysUserRoleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown SysUserRole mutation op: %q", m.Op())
	}
}
...
func (c *XxxDemoClient) mutate(ctx context.Context, m *XxxDemoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entscheme: unknown XxxDemo mutation op: %q", m.Op())
	}
}
