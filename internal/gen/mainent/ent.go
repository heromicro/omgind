	...
	return func(s *sql.Selector) {
		for _, f := range fields {
			if err := checkColumn(s.TableName(), f); err != nil {
				s.AddError(&ValidationError{Name: f, err: fmt.Errorf("mainent: %w", err)})
			}
...
//	Aggregate(mainent.As(mainent.Sum(field1), "sum_field1"), (mainent.As(mainent.Sum(field2), "sum_field2")).
//	Scan(ctx, &v)
...
func Max(field string) AggregateFunc {
	return func(s *sql.Selector) string {
		if err := checkColumn(s.TableName(), field); err != nil {
			s.AddError(&ValidationError{Name: field, err: fmt.Errorf("mainent: %w", err)})
			return ""
		}
...
func (e *NotFoundError) Error() string {
	return "mainent: " + e.label + " not found"
}
...
func (e *NotSingularError) Error() string {
	return "mainent: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "mainent: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "mainent: constraint failed: " + e.msg
}
...
func (s *selector) Strings(ctx context.Context) ([]string, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("mainent: Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) String(ctx context.Context) (_ string, err error) {
	...
	default:
		err = fmt.Errorf("mainent: Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Ints(ctx context.Context) ([]int, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("mainent: Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("mainent: Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Float64s(ctx context.Context) ([]float64, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("mainent: Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("mainent: Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Bools(ctx context.Context) ([]bool, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("mainent: Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("mainent: Bools returned %d results when one was expected", len(v))
	}
	return
}
