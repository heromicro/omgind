...
type Client struct {
	...
	// OrgDept is the client for interacting with the OrgDept builders.
	OrgDept *OrgDeptClient
...
func (c *Client) init() {
	...
	c.OrgDept = NewOrgDeptClient(c.config)
...
var ErrTxStarted = errors.New("mainent: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("mainent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	switch m := m.(type) {
	case *OrgDeptMutation:
		return c.OrgDept.mutate(ctx, m)
	...
	default:
		return nil, fmt.Errorf("mainent: unknown mutation type %T", m)
	}
}

// OrgDeptClient is a client for the OrgDept schema.
type OrgDeptClient struct {
	config
}

// NewOrgDeptClient returns a client for the OrgDept from the given config.
func NewOrgDeptClient(c config) *OrgDeptClient {
	return &OrgDeptClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `orgdept.Hooks(f(g(h())))`.
func (c *OrgDeptClient) Use(hooks ...Hook) {
	c.hooks.OrgDept = append(c.hooks.OrgDept, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `orgdept.Intercept(f(g(h())))`.
func (c *OrgDeptClient) Intercept(interceptors ...Interceptor) {
	c.inters.OrgDept = append(c.inters.OrgDept, interceptors...)
}

// Create returns a builder for creating a OrgDept entity.
func (c *OrgDeptClient) Create() *OrgDeptCreate {
	mutation := newOrgDeptMutation(c.config, OpCreate)
	return &OrgDeptCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of OrgDept entities.
func (c *OrgDeptClient) CreateBulk(builders ...*OrgDeptCreate) *OrgDeptCreateBulk {
	return &OrgDeptCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *OrgDeptClient) MapCreateBulk(slice any, setFunc func(*OrgDeptCreate, int)) *OrgDeptCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &OrgDeptCreateBulk{err: fmt.Errorf("calling to OrgDeptClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*OrgDeptCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
...
// Update returns an update builder for OrgDept.
func (c *OrgDeptClient) Update() *OrgDeptUpdate {
	mutation := newOrgDeptMutation(c.config, OpUpdate)
	return &OrgDeptUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *OrgDeptClient) UpdateOne(od *OrgDept) *OrgDeptUpdateOne {
	mutation := newOrgDeptMutation(c.config, OpUpdateOne, withOrgDept(od))
	return &OrgDeptUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *OrgDeptClient) UpdateOneID(id string) *OrgDeptUpdateOne {
	mutation := newOrgDeptMutation(c.config, OpUpdateOne, withOrgDeptID(id))
	return &OrgDeptUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for OrgDept.
func (c *OrgDeptClient) Delete() *OrgDeptDelete {
	mutation := newOrgDeptMutation(c.config, OpDelete)
	return &OrgDeptDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *OrgDeptClient) DeleteOne(od *OrgDept) *OrgDeptDeleteOne {
	return c.DeleteOneID(od.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *OrgDeptClient) DeleteOneID(id string) *OrgDeptDeleteOne {
	builder := c.Delete().Where(orgdept.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &OrgDeptDeleteOne{builder}
}

// Query returns a query builder for OrgDept.
func (c *OrgDeptClient) Query() *OrgDeptQuery {
	return &OrgDeptQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeOrgDept},
		inters: c.Interceptors(),
	}
}

// Get returns a OrgDept entity by its id.
func (c *OrgDeptClient) Get(ctx context.Context, id string) (*OrgDept, error) {
	return c.Query().Where(orgdept.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *OrgDeptClient) GetX(ctx context.Context, id string) *OrgDept {
...
// QueryParent queries the parent edge of a OrgDept.
func (c *OrgDeptClient) QueryParent(od *OrgDept) *OrgDeptQuery {
...
// QueryChildren queries the children edge of a OrgDept.
func (c *OrgDeptClient) QueryChildren(od *OrgDept) *OrgDeptQuery {
	query := (&OrgDeptClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := od.ID
		step := sqlgraph.NewStep(
...
// QueryOrgan queries the organ edge of a OrgDept.
func (c *OrgDeptClient) QueryOrgan(od *OrgDept) *OrgOrganQuery {
...
func (c *OrgDeptClient) Interceptors() []Interceptor {
	return c.inters.OrgDept
}

func (c *OrgDeptClient) mutate(ctx context.Context, m *OrgDeptMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&OrgDeptCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&OrgDeptUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&OrgDeptUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&OrgDeptDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("mainent: unknown OrgDept mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *OrgOrganClient) MapCreateBulk(slice any, setFunc func(*OrgOrganCreate, int)) *OrgOrganCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &OrgOrganCreateBulk{err: fmt.Errorf("calling to OrgOrganClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*OrgOrganCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// QueryDepts queries the depts edge of a OrgOrgan.
func (c *OrgOrganClient) QueryDepts(oo *OrgOrgan) *OrgDeptQuery {
	query := (&OrgDeptClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := oo.ID
		step := sqlgraph.NewStep(
...
func (c *OrgOrganClient) mutate(ctx context.Context, m *OrgOrganMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown OrgOrgan mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *OrgPositionClient) MapCreateBulk(slice any, setFunc func(*OrgPositionCreate, int)) *OrgPositionCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &OrgPositionCreateBulk{err: fmt.Errorf("calling to OrgPositionClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*OrgPositionCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *OrgPositionClient) mutate(ctx context.Context, m *OrgPositionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown OrgPosition mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *OrgStaffClient) MapCreateBulk(slice any, setFunc func(*OrgStaffCreate, int)) *OrgStaffCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &OrgStaffCreateBulk{err: fmt.Errorf("calling to OrgStaffClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*OrgStaffCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *OrgStaffClient) mutate(ctx context.Context, m *OrgStaffMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown OrgStaff mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysAddressClient) MapCreateBulk(slice any, setFunc func(*SysAddressCreate, int)) *SysAddressCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysAddressCreateBulk{err: fmt.Errorf("calling to SysAddressClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysAddressCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysAnnexClient) MapCreateBulk(slice any, setFunc func(*SysAnnexCreate, int)) *SysAnnexCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysAnnexCreateBulk{err: fmt.Errorf("calling to SysAnnexClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysAnnexCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *SysDictClient) mutate(ctx context.Context, m *SysDictMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysDict mutation op: %q", m.Op())
	}
}
...
func (c *SysDictItemClient) mutate(ctx context.Context, m *SysDictItemMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysDictItem mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysDistrictClient) MapCreateBulk(slice any, setFunc func(*SysDistrictCreate, int)) *SysDistrictCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysDistrictCreateBulk{err: fmt.Errorf("calling to SysDistrictClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysDistrictCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *SysDistrictClient) mutate(ctx context.Context, m *SysDistrictMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysDistrict mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysJwtBlockClient) MapCreateBulk(slice any, setFunc func(*SysJwtBlockCreate, int)) *SysJwtBlockCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysJwtBlockCreateBulk{err: fmt.Errorf("calling to SysJwtBlockClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysJwtBlockCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *SysJwtBlockClient) mutate(ctx context.Context, m *SysJwtBlockMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysJwtBlock mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysLoggingClient) MapCreateBulk(slice any, setFunc func(*SysLoggingCreate, int)) *SysLoggingCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysLoggingCreateBulk{err: fmt.Errorf("calling to SysLoggingClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysLoggingCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *SysLoggingClient) mutate(ctx context.Context, m *SysLoggingMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysLogging mutation op: %q", m.Op())
	}
}
...
func (c *SysMenuClient) mutate(ctx context.Context, m *SysMenuMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysMenu mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysMenuActionClient) MapCreateBulk(slice any, setFunc func(*SysMenuActionCreate, int)) *SysMenuActionCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysMenuActionCreateBulk{err: fmt.Errorf("calling to SysMenuActionClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysMenuActionCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *SysMenuActionClient) mutate(ctx context.Context, m *SysMenuActionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysMenuAction mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysMenuActionResourceClient) MapCreateBulk(slice any, setFunc func(*SysMenuActionResourceCreate, int)) *SysMenuActionResourceCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysMenuActionResourceCreateBulk{err: fmt.Errorf("calling to SysMenuActionResourceClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysMenuActionResourceCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *SysMenuActionResourceClient) mutate(ctx context.Context, m *SysMenuActionResourceMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysMenuActionResource mutation op: %q", m.Op())
	}
}
...
func (c *SysRoleClient) mutate(ctx context.Context, m *SysRoleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysRole mutation op: %q", m.Op())
	}
}
...
func (c *SysRoleMenuClient) mutate(ctx context.Context, m *SysRoleMenuMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysRoleMenu mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysTeamClient) MapCreateBulk(slice any, setFunc func(*SysTeamCreate, int)) *SysTeamCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysTeamCreateBulk{err: fmt.Errorf("calling to SysTeamClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysTeamCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *SysTeamClient) mutate(ctx context.Context, m *SysTeamMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysTeam mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SysTeamUserClient) MapCreateBulk(slice any, setFunc func(*SysTeamUserCreate, int)) *SysTeamUserCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SysTeamUserCreateBulk{err: fmt.Errorf("calling to SysTeamUserClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SysTeamUserCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *SysTeamUserClient) mutate(ctx context.Context, m *SysTeamUserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysTeamUser mutation op: %q", m.Op())
	}
}
...
func (c *SysUserClient) mutate(ctx context.Context, m *SysUserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysUser mutation op: %q", m.Op())
	}
}
...
func (c *SysUserRoleClient) mutate(ctx context.Context, m *SysUserRoleMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown SysUserRole mutation op: %q", m.Op())
	}
}
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *XxxDemoClient) MapCreateBulk(slice any, setFunc func(*XxxDemoCreate, int)) *XxxDemoCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &XxxDemoCreateBulk{err: fmt.Errorf("calling to XxxDemoClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*XxxDemoCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
func (c *XxxDemoClient) mutate(ctx context.Context, m *XxxDemoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("mainent: unknown XxxDemo mutation op: %q", m.Op())
	}
}
