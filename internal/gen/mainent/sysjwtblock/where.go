...
func IDEqualFold(id string) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(sql.FieldEqualFold(FieldID, id))
}

// IDContainsFold applies the ContainsFold predicate on the ID field.
func IDContainsFold(id string) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(sql.FieldContainsFold(FieldID, id))
}
...
func And(predicates ...predicate.SysJwtBlock) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.SysJwtBlock) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.SysJwtBlock) predicate.SysJwtBlock {
	return predicate.SysJwtBlock(sql.NotPredicates(p))
}
