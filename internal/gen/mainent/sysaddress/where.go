...
func HasOrgan() predicate.SysAddress {
...
func And(predicates ...predicate.SysAddress) predicate.SysAddress {
	return predicate.SysAddress(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.SysAddress) predicate.SysAddress {
	return predicate.SysAddress(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.SysAddress) predicate.SysAddress {
	return predicate.SysAddress(sql.NotPredicates(p))
}
