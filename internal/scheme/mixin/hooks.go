...
import (
	"entgo.io/ent"
	// gen "github.com/heromicro/omgind/internal/gen/mainent"
...
func (MpttTreeMixin) Hooks() []ent.Hook {
	return []ent.Hook{
		...
		// 		return hook.SysDistrictFunc(func(ctx context.Context, m *mainent.SysDistrictMutation) (ent.Value, error) {
		// 			isLeaf, ok := m.IsLeaf()
		// 			if !ok {
